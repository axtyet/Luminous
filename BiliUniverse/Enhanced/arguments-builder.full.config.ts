...
export const args: ArgumentItem[] = [homeSwitch, homeTab, homeTabDefault, homeTopLeft, homeTop, homeTopMore, bottom, regionSwitch, mineSwitch, mineIPadSwitch, storage, logLevel];
