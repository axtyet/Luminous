 ...
 *
 * [Script]
 * 财新每日任务 = type=cron,cronexp=5 0 * * *,wake-system=1,timeout=120,script-path=https://raw.githubusercontent.com/axtyet/Luminous/main/ddgksf2013/Scripts/caixin_daily.js
 *
 * 财新Cookie抓取 = type=http-request,pattern=^https:\/\/gateway\.caixin\.com\/api\/(?:signin\/markRecord\/markRecordForCookie|answeractivity\/userParticipateActivity\/(?:userGetActivityForCookie|findUserActivityDetailForCookie)|integral\/assignmentConfig\/findAssignmentConfigList|app-api\/integral\/getUserIntegral),script-path=https://raw.githubusercontent.com/axtyet/Luminous/main/ddgksf2013/Scripts/caixin_daily.js,timeout=10
 *
 * [MITM]
 ...
 *
 * [Script]
 * cron "5 0 * * *" tag=财新每日任务, script-path=https://raw.githubusercontent.com/axtyet/Luminous/main/ddgksf2013/Scripts/caixin_daily.js, timeout=120
 *
 * http-request ^https:\/\/gateway\.caixin\.com\/api\/(?:signin\/markRecord\/markRecordForCookie|answeractivity\/userParticipateActivity\/(?:userGetActivityForCookie|findUserActivityDetailForCookie)|integral\/assignmentConfig\/findAssignmentConfigList|app-api\/integral\/getUserIntegral) tag=财新Cookie抓取, script-path=https://raw.githubusercontent.com/axtyet/Luminous/main/ddgksf2013/Scripts/caixin_daily.js, timeout=10, enable=true
 *
 * [MITM]
 * hostname = gateway.caixin.com
 *
 ...
 * [task_local]
 * # 财新每日任务
 * 5 0 * * * https://raw.githubusercontent.com/axtyet/Luminous/main/ddgksf2013/Scripts/caixin_daily.js, tag=财新每日任务, enabled=true
 *
 * [rewrite_local]
 * # 财新Cookie抓取
 * ^https:\/\/gateway\.caixin\.com\/api\/(?:signin\/markRecord\/markRecordForCookie|answeractivity\/userParticipateActivity\/(?:userGetActivityForCookie|findUserActivityDetailForCookie)|integral\/assignmentConfig\/findAssignmentConfigList|app-api\/integral\/getUserIntegral) url script-request-header https://raw.githubusercontent.com/axtyet/Luminous/main/ddgksf2013/Scripts/caixin_daily.js
 *
[mitm]
hostname = gateway.caixin.com
 *
 ...
 *************************
 *
 * https://raw.githubusercontent.com/axtyet/Luminous/main/ddgksf2013/Scripts/caixin_daily.js
 *
 *
 *************************
 【BoxJS 地址】:
