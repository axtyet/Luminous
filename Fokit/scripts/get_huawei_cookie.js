...
================Quantumult X配置=================
[rewrite_local]
^https:\/\/cloud.huawei.com/wapFindPhone url script-request-header https://raw.githubusercontent.com/axtyet/Quan-X/main/Fokit/scripts/get_huawei_cookie.js
[MITM]
hostname = cloud.huawei.com
====================Surge配置====================
[Script]
华为云服务 Cookie = type=http-request,pattern=^https:\/\/cloud.huawei.com/wapFindPhone,requires-body=0,max-size=0,timeout=1000,script-path=https://raw.githubusercontent.com/axtyet/Quan-X/main/Fokit/scripts/get_huawei_cookie.js,script-update-interval=0
[MITM]
hostname = %APPEND% cloud.huawei.com
====================Loon配置=====================
[Script]
http-request ^https:\/\/cloud.huawei.com/wapFindPhone tag=华为云服务 Cookie, script-path=https://raw.githubusercontent.com/axtyet/Quan-X/main/Fokit/scripts/get_huawei_cookie.js,requires-body=1
[MITM]
hostname = cloud.huawei.com
*/
